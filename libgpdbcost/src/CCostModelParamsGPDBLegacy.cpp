...
//
//---------------------------------------------------------------------------
CCostModelParamsGPDBLegacy::CCostModelParamsGPDBLegacy(IMemoryPool *pmp)
	: m_pmp(pmp)
{
	...
	m_rgpcp[EcpNLJOuterFactor] = GPOS_NEW(pmp)
...
CCostModelParamsGPDBLegacy::PcpLookup(ULONG ulId) const
{
...
//---------------------------------------------------------------------------
void
CCostModelParamsGPDBLegacy::SetParam(ULONG ulId, CDouble dVal,
