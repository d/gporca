...
public:
	...
	static BOOL
	FBinaryCoercibleCastedScId(CExpression *pexpr, CColRef *pcr);

	// is the given expression a binary coercible cast of a scalar identifier
	static BOOL
	FBinaryCoercibleCastedScId(CExpression *pexpr);
