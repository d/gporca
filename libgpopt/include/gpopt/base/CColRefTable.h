...
public:
	// ctors
	CColRefTable(const CColumnDescriptor *pcd, ULONG ulId, const CName *pname,
				 ULONG ulOpSource);

	CColRefTable(const IMDType *pmdtype, INT iTypeModifier, INT iAttno,
				 BOOL fNullable, ULONG ulId, const CName *pname,
				 ULONG ulOpSource, ULONG ulWidth = ULONG_MAX);
