...
private:
	...
	BOOL
	FEvalComparison(IMemoryPool *pmp, const IDatum *pdatum1,
					const IDatum *pdatum2, IMDType::ECmpType ecmpt) const;
...
public:
	...
	virtual BOOL
	FEqual(const IDatum *pdatum1, const IDatum *pdatum2) const;

	// tests if the first argument is less than the second
	virtual BOOL
	FLessThan(const IDatum *pdatum1, const IDatum *pdatum2) const;

	// tests if the first argument is less or equal to the second
	virtual BOOL
	FLessThanOrEqual(const IDatum *pdatum1, const IDatum *pdatum2) const;

	// tests if the first argument is greater than the second
	virtual BOOL
	FGreaterThan(const IDatum *pdatum1, const IDatum *pdatum2) const;

	// tests if the first argument is greater or equal to the second
	virtual BOOL
	FGreaterThanOrEqual(const IDatum *pdatum1, const IDatum *pdatum2) const;
