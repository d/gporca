...
public:
	...
	void
	SetExpectedPartitionSelectors(COperator *pop, CCostContext *pcc);
	...
	CDrvdPropPlan *
	PdpplanCTEProducer(ULONG ulCTEId) const;

	// copy plan properties of given CTE prdoucer
	void
	CopyCTEProducerProps(CDrvdPropPlan *pdpplan, ULONG ulCTEId);
