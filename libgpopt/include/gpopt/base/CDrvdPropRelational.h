...
private:
	...
	static DrgPfd *
	PdrgpfdChild(IMemoryPool *pmp, ULONG ulChildIndex,
				 CExpressionHandle &exprhdl);

	// helper for creating local FDs
	static DrgPfd *
	PdrgpfdLocal(IMemoryPool *pmp, CExpressionHandle &exprhdl);

	// helper for deriving FD's
	static DrgPfd *
	Pdrgpfd(IMemoryPool *pmp, CExpressionHandle &exprhdl);
...
public:
	...
	// derivation function
	void
	Derive(IMemoryPool *pmp, CExpressionHandle &exprhdl,
	...
	static CDrvdPropRelational *
	Pdprel(CDrvdProp *pdp);

	// check for satisfying required plan properties
	virtual BOOL
	FSatisfies(const CReqdPropPlan *prpp) const;
