...
public:
	// ctor
	explicit CPartKeys(DrgDrgPcr *pdrgpdrgpcr);
	...
	static DrgPpartkeys *
	PdrgppartkeysCopy(IMemoryPool *pmp, const DrgPpartkeys *pdrgppartkeys);
