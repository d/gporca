...
#define GRAPHVIZ_BOX(x) GRAPHVIZ_SHAPE("box", x)
	...
	void
	Walk(IMemoryPool *pmp, PfWalker Pfpv, void *pvContext) const
	{
		// retrieve all states
...
public:
	...
	BOOL
	FReachable(IMemoryPool *pmp) const
	{
	...
	void
	Unreachable(IMemoryPool *pmp, TEnumState **ppestate, ULONG *pulSize) const
	{
