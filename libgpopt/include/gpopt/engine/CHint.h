...
public:
	// ctor
	CHint(ULONG ulMinNumOfPartsToRequireSortOnInsert,
		  ULONG ulJoinArityForAssociativityCommutativity,
		  ULONG ulArrayExpansionThreshold, ULONG ulJoinOrderDPLimit,
		  ULONG ulBroadcastThreshold, BOOL fEnforceConstraintsOnDML)
	...
	static CHint *
	PhintDefault(IMemoryPool *pmp)
	{
		return GPOS_NEW(pmp)
			CHint(INT_MAX, /* ulMinNumOfPartsToRequireSortOnInsert */
