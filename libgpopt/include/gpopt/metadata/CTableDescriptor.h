...
private:
	...
	BOOL
	FDescriptorWithPartialIndexes();

public:
	// ctor
	CTableDescriptor(IMemoryPool *, IMDId *pmdid, const CName &,
	...
	ULONG
	UlPos(const CColumnDescriptor *, const DrgPcoldesc *) const;
