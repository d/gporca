...
public:
	// ctor
	CDXLMinidump(CBitSet *pbs, COptimizerConfig *poconf, CDXLNode *pdxlnQuery,
				 DrgPdxln *pdrgpdxlnQueryOutput, DrgPdxln *pdrgpdxlnCTE,
				 CDXLNode *pdxlnPlan, DrgPimdobj *pdrgpmdobj,
				 DrgPsysid *pdrgpsysid, ULLONG ullPlanId,
