...
public:
	// ctors
	explicit CLogicalDynamicIndexGet(IMemoryPool *pmp);

	CLogicalDynamicIndexGet(IMemoryPool *pmp, const IMDIndex *pmdindex,
	...
	static BOOL
	FPartialIndex(CTableDescriptor *ptabdesc, const IMDIndex *pmdindex);
