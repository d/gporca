...
private:
	...
	INT
	ITriggerType(const IMDTrigger *pmdtrigger) const;

public:
	// ctor
	explicit CLogicalRowTrigger(IMemoryPool *pmp);

	// ctor
	CLogicalRowTrigger(IMemoryPool *pmp, IMDId *pmdidRel, INT iType,
					   DrgPcr *pdrgpcrOld, DrgPcr *pdrgpcrNew);
