...
public:
	// ctor
	explicit CLogicalUnionAll(IMemoryPool *pmp);

	CLogicalUnionAll(IMemoryPool *pmp, DrgPcr *pdrgpcrOutput,
	...
	static IStatistics *
	PstatsDeriveUnionAll(IMemoryPool *pmp, CExpressionHandle &exprhdl);
