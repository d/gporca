...
private:
	...
	CDistributionSpec *
	PdsRequiredIntermediateAgg(IMemoryPool *pmp, ULONG ulOptReq) const;

	// compute required distribution of the n-th child of a global aggregate
	CDistributionSpec *
	PdsRequiredGlobalAgg(IMemoryPool *pmp, CExpressionHandle &exprhdl,
						 CDistributionSpec *pdsInput, ULONG ulChildIndex,
						 DrgPcr *pdrgpcrGrp, DrgPcr *pdrgpcrGrpMinimal,
	...
	PdsMaximalHashed(IMemoryPool *pmp, DrgPcr *pdrgpcr);
...
protected:
	...
	CColRefSet *
	PcrsRequiredAgg(IMemoryPool *pmp, CExpressionHandle &exprhdl,
					CColRefSet *pcrsRequired, ULONG ulChildIndex,
					DrgPcr *pdrgpcrGrp);

	// compute required distribution of the n-th child
	CDistributionSpec *
	PdsRequiredAgg(IMemoryPool *pmp, CExpressionHandle &exprhdl,
				   CDistributionSpec *pdsInput, ULONG ulChildIndex,
...
public:
	// ctor
	CPhysicalAgg(IMemoryPool *pmp, DrgPcr *pdrgpcr,
	...
	PdsRequired(IMemoryPool *pmp, CExpressionHandle &exprhdl,
				...
				ULONG ulOptReq) const
	{
		return PdsRequiredAgg(pmp, exprhdl, pdsRequired, ulChildIndex, ulOptReq,
