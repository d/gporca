...
private:
	...
	PdshashedCreateMatching(IMemoryPool *pmp,
	...
	CDistributionSpec *
	PdsDeriveFromReplicatedOuter(IMemoryPool *pmp, CDistributionSpec *pdsOuter,
								 CDistributionSpec *pdsInner) const;
...
public:
	// ctor
	CPhysicalInnerHashJoin(IMemoryPool *pmp, DrgPexpr *pdrgpexprOuterKeys,
