...
protected:
	...
	PppsRequiredNLJoinChild(IMemoryPool *pmp, CExpressionHandle &exprhdl,
...
public:
	// ctor
	explicit CPhysicalNLJoin(IMemoryPool *pmp);
				 ...
				 DrgPdp *pdrgpdpCtxt, ULONG ulOptReq)
	{
		...
		return PppsRequiredNLJoinChild(pmp, exprhdl, pppsRequired, ulChildIndex,
