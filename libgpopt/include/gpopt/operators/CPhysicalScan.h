...
protected:
	...
	PpimDeriveFromDynamicScan(IMemoryPool *pmp, ULONG ulPartIndexId,
							  IMDId *pmdidRel, DrgDrgPcr *pdrgpdrgpcrPart,
...
public:
	// ctors
	CPhysicalScan(IMemoryPool *pmp, const CName *pname, CTableDescriptor *,
				  DrgPcr *pdrgpcr);
	...
	PstatsDerive(IMemoryPool *pmp, CExpressionHandle &exprhdl,
				 CReqdPropPlan *prpplan, DrgPstat *pdrgpstatCtxt) const = 0;

	// conversion function
	static CPhysicalScan *
