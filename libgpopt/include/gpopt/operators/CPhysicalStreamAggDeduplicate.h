...
public:
	// ctor
	CPhysicalStreamAggDeduplicate(IMemoryPool *pmp, DrgPcr *pdrgpcr,
	...
	{
		return PcrsRequiredAgg(pmp, exprhdl, pcrsRequired, ulChildIndex,
							   m_pdrgpcrKeys);
	}
	...
	{
		return PosRequiredStreamAgg(pmp, exprhdl, posRequired, ulChildIndex,
									m_pdrgpcrKeys);
	}
