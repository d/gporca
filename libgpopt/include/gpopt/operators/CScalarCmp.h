...
public:
	// ctor
	CScalarCmp(IMemoryPool *pmp, IMDId *pmdidOp, const CWStringConst *pstrOp,
	...
	virtual CScalarCmp *
	PopCommutedOp(IMemoryPool *pmp, COperator *pop);

	// get the string representation of a metadata object
	static CWStringConst *
	Pstr(IMemoryPool *pmp, CMDAccessor *pmda, IMDId *pmdid);

	// get metadata id of the commuted operator
	static IMDId *
	PmdidCommuteOp(CMDAccessor *pmda, COperator *pop);
