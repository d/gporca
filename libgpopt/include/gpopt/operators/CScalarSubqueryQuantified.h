...
protected:
	// ctor
	CScalarSubqueryQuantified(IMemoryPool *pmp, IMDId *pmdidScalarOp,
...
public:
	...
	virtual CColRefSet *
	PcrsUsed(IMemoryPool *pmp, CExpressionHandle &exprhdl);
	...
	virtual CExpression *
	PexprSubqueryPred(CSubqueryHandler &sh, CExpression *pexprOuter,
