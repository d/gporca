...
private:
	...
	static void
	SplitPrjList(IMemoryPool *pmp, CExpression *pexprSeqPrj,
				 DrgPexpr **ppdrgpexprDistinctAggsPrjElems,
				 DrgPexpr **ppdrgpexprOtherPrjElems, DrgPos **ppdrgposOther,
