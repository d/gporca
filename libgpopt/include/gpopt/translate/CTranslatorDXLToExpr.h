...
private:
	...
	DrgPexpr *
	PdrgpexprPreprocessSetOpInputs(const CDXLNode *pdxln,
	...
	Efb(EdxlFrameBoundary edxlfb) const;
	...
	Efes(EdxlFrameExclusionStrategy edxlfeb) const;

	// translate a DXL scalar array
	CExpression *
	PexprArray(const CDXLNode *pdxln);

	// translate a DXL scalar arrayref
	CExpression *
	PexprArrayRef(const CDXLNode *pdxln);

	// translate a DXL scalar arrayref index list
	CExpression *
	PexprArrayRefIndexList(const CDXLNode *pdxln);

	// translate the arrayref index list type
	CScalarArrayRefIndexList::EIndexListType
	Eilt(const CDXLScalarArrayRefIndexList::EIndexListBound eilb);

	// translate a DXL scalar array compare
	CExpression *
	PexprArrayCmp(const CDXLNode *pdxln);
