...
private:
	...
	// and output columns
	CExpression *
	PexprLogicalJoinOverCTEs(IMemoryPool *pmp, EdxlJoinType edxljointype,
							 ULONG ulLeftCTEId, DrgPcr *pdrgpcrLeft,
							 ULONG ulRightCTEId, DrgPcr *pdrgpcrRight,
							 CExpression *pexprScalar) const;

public:
	// ctor
	explicit CXformExpandFullOuterJoin(IMemoryPool *pmp);
