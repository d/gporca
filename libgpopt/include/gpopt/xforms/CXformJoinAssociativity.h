...
private:
	...
	void
	CreatePredicates(IMemoryPool *pmp, CExpression *pexpr,
					 DrgPexpr *pdrgpexprLower, DrgPexpr *pdrgpexprUpper) const;

public:
	// ctor
	explicit CXformJoinAssociativity(IMemoryPool *pmp);
