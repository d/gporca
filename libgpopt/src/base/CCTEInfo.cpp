...
//		return GPOS_ULONG_MAX if column is not found in local map
//
//---------------------------------------------------------------------------
ULONG
CCTEInfo::CCTEInfoEntry::UlConsumerColPos
	...
	const
{
	...
	ULONG ulConsumers = UlConsumersInParent(ulCTEId, GPOS_ULONG_MAX);
...
CCTEInfo::MarkUnusedCTEs()
{
	...
	FindConsumersInParent(GPOS_ULONG_MAX, pbsUnusedConsumers, &stack);
