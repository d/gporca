...
const BYTE CScalarBooleanTest::m_rgBoolEvalMap[][3] = {
	...
	{EbtIsNotFalse, EberUnknown,
	 EberUnknown},  // IS_NOT_FALSE(Unknown) = Unknown
	...
	{EbtIsNotUnknown, EberUnknown,
	 EberUnknown},  // IS_NOT_UNKNOWN(Unknown) = Unknown
};
...
//---------------------------------------------------------------------------
BOOL
CScalarBooleanTest::FMatch(COperator *pop) const
{
	if (pop->Eopid() == Eopid())
	{
...
CScalarBooleanTest::Eber(DrgPul *pdrgpulChildren) const
{
