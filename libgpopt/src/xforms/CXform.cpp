...
//---------------------------------------------------------------------------
BOOL
CXform::FPromising(IMemoryPool *pmp, const CXform *pxform, CExpression *pexpr)
{
...
//---------------------------------------------------------------------------
CBitSet *
CXform::PbsIndexJoinXforms(IMemoryPool *pmp)
{
	...
	(void) pbs->FExchangeSet(GPOPT_DISABLE_XFORM_TF(
...
//---------------------------------------------------------------------------
CBitSet *
CXform::PbsBitmapIndexXforms(IMemoryPool *pmp)
{
	CBitSet *pbs = GPOS_NEW(pmp) CBitSet(pmp, EopttraceSentinel);
	(void) pbs->FExchangeSet(
...
//---------------------------------------------------------------------------
CBitSet *
CXform::PbsHeterogeneousIndexXforms(IMemoryPool *pmp)
{
	CBitSet *pbs = GPOS_NEW(pmp) CBitSet(pmp, EopttraceSentinel);
...
//	Caller takes ownership of the returned set
CBitSet *
CXform::PbsHashJoinXforms(IMemoryPool *pmp)
{
	CBitSet *pbs = GPOS_NEW(pmp) CBitSet(pmp, EopttraceSentinel);
...
CBitSet *
CXform::PbsJoinOrderInQueryXforms(IMemoryPool *pmp)
{
	CBitSet *pbs = GPOS_NEW(pmp) CBitSet(pmp, EopttraceSentinel);
...
CBitSet *
CXform::PbsJoinOrderOnGreedyXforms(IMemoryPool *pmp)
{
	CBitSet *pbs = GPOS_NEW(pmp) CBitSet(pmp, EopttraceSentinel);
