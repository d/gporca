...
//
//---------------------------------------------------------------------------
CXformImplementConstTableGet::CXformImplementConstTableGet(IMemoryPool *pmp)
	: CXformImplementation(
		  // pattern
		  GPOS_NEW(pmp)
			  CExpression(pmp, GPOS_NEW(pmp) CLogicalConstTableGet(pmp)))
{
}
										...
										CExpression *pexpr) const
{
	...
	CExpression *pexprAlt = GPOS_NEW(pmp)
		CExpression(pmp, GPOS_NEW(pmp) CPhysicalConstTableGet(
							 pmp, pdrgpcoldesc, pdrgpdrgpdatum, pdrgpcrOutput));
