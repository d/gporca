...
//
//---------------------------------------------------------------------------
CXformProject2ComputeScalar::CXformProject2ComputeScalar(IMemoryPool *pmp)
	:  // pattern
									   ...
									   CExpression *pexpr) const
{
	...
	CExpression *pexprComputeScalar = GPOS_NEW(pmp)
		CExpression(pmp, GPOS_NEW(pmp) CPhysicalComputeScalar(pmp),
