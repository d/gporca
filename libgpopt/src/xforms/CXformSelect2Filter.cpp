...
//
//---------------------------------------------------------------------------
CXformSelect2Filter::CXformSelect2Filter(IMemoryPool *pmp)
	:  // pattern
							   ...
							   CExpression *pexpr) const
{
	...
	CExpression *pexprFilter = GPOS_NEW(pmp) CExpression(
		pmp, GPOS_NEW(pmp) CPhysicalFilter(pmp), pexprRelational, pexprScalar);
