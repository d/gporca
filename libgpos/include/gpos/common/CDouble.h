...
public:
	...
	// assignment
	inline CDouble &
	operator=(const CDouble &fpRight)
	{
	...
	friend CDouble
	operator+(const CDouble &fpLeft, const CDouble &fpRight)
	{
	...
	inline static BOOL
	FEqual(DOUBLE dLeft, DOUBLE dRight, DOUBLE dPrecision = GPOS_FP_ABS_MIN)
	{
...
// print shorthand
inline IOstream &
operator<<(IOstream &os, CDouble fp)
{
