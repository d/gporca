...
public:
	...
	// ctor
	SLink() : m_pvNext(NULL), m_pvPrev(NULL)
	{
	}
};
...
public:
	// ctor
	CList() : m_cOffset(ULONG_MAX), m_ulSize(0), m_ptHead(NULL), m_ptTail(NULL)
	{
	}
