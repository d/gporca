...
private:
	...
	ULONG
	UlBucketIndex(const K &key) const
	{
	...
	SBucket &
	Bucket(const ULONG ulIndex) const
	{
...
public:
	...
	void
	Init(IMemoryPool *pmp, ULONG cSize, ULONG cLinkOffset, ULONG cKeyOffset,
		 const K *pkeyInvalid, ULONG (*pfuncHash)(const K &),
	...
	void
	DestroyEntries(DestroyEntryFuncPtr pfuncDestroy)
	{
