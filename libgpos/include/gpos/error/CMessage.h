...
public:
	...
	//
	// ctor
	CMessage(CException exc, ULONG ulSev, const WCHAR *wszFmt, ULONG ulLenFmt,
			 ULONG ulParams, const WCHAR *wszComment, ULONG ulLenComment);
	...
	static void
	FormatMessage(CWStringStatic *pstr, ULONG ulMajor, ULONG ulMinor, ...);
