...
public:
	// ctor
	CCacheEntry(IMemoryPool *pmp, K pKey, T pVal, ULONG ulGClockCounter)
		: m_pmp(pmp),
		  m_pVal(pVal),
		  m_fDeleted(false),
	...
	void
	SetGClockCounter(ULONG ulGClockCounter)
	{
		m_ulGClockCounter = ulGClockCounter;
	}
