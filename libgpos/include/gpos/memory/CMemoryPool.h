...
protected:
	// ctor
	CMemoryPool(IMemoryPool *pmpUnderlying, BOOL fOwnsUnderlying,
				BOOL fThreadSafe);
	...
	static const ULONG_PTR m_ulpInvalid;
...
public:
	...
	void *
	PvFinalizeAlloc(void *pv, ULONG ulAlloc, EAllocationType eat);

	// return allocation to owning memory pool
	static void
	FreeAlloc(void *pv, EAllocationType eat);
