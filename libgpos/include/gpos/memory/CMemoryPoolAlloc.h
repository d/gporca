...
public:
	// ctor
	CMemoryPoolAlloc(void *(*pfnAlloc)(SIZE_T), void (*pfnFree)(void *))
		: CMemoryPool(NULL /*pmpUnderlying*/, false /*fOwnsUnderlying*/,
					  true /*fThreadSafe*/
					  ),
		  m_pfnAlloc(pfnAlloc),
		  m_pfnFree(pfnFree)
...
#ifdef GPOS_DEBUG
		if (NULL != ITask::PtskSelf() && GPOS_FTRACE(EtraceSimulateOOM) &&
			NULL == pv)
		{
