...
private:
	...
	SBlockDescriptor *
	PbdProvider(CAutoSpinlock &as, ULONG ulAlloc);
...
public:
	// ctor
	CMemoryPoolStack(IMemoryPool *pmp, ULLONG ullCapacity, BOOL fThreadSafe,
