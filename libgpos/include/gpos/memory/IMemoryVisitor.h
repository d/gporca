...
public:
	...
	virtual void
	Visit(void *pvUserAddr, SIZE_T ulUserSize, void *pvTotalAddr,
		  SIZE_T ulTotalSize, const CHAR *szAllocFilename,
		  const ULONG ulAllocLine, ULLONG cAllocSeqNumber,
		  CStackDescriptor *psd) = 0;
};
}  // namespace gpos
