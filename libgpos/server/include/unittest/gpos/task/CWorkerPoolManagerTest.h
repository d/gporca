...
public:
	...
	static void
	Unittest_TestTaskPerformance(ULONG culWrkrCnt, ULONG culIterCnt,
								 void *funcSingle(void *),
								 void *funcRepeated(void *));

	static void
	Unittest_TestSingleTaskPerformance(IMemoryPool *pmp, ULONG culWrkrCnt,
									   ULONG culIterCnt,
									   void *funcRepeated(void *));

	static void
	Unittest_TestMultiTaskPerformance(IMemoryPool *pmp, ULONG culWrkrCnt,
									  ULONG culIterCnt,
									  void *funcSingle(void *));

	static void
	Unittest_Stress(ULONG culWrkrCnt, ULONG culTskCnt, void *func(void *));
	static void *
	PvUnittest_ShortRepeated(void *);
	static void *
	PvUnittest_LongRepeated(void *);
