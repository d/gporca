...
CHashMapTest::EresUnittest_Basic()
{
	...
	typedef CHashMap<ULONG_PTR, CHAR, UlHashPtr<ULONG_PTR>,
					 gpos::FEqual<ULONG_PTR>, CleanupNULL<ULONG_PTR>,
					 CleanupNULL<CHAR> >
		HMUlChar;
...
CHashMapTest::EresUnittest_Ownership()
{
	...
	typedef CHashMap<ULONG_PTR, CHAR, UlHashPtr<ULONG_PTR>,
					 gpos::FEqual<ULONG_PTR>, CleanupDelete<ULONG_PTR>,
					 CleanupDeleteRg<CHAR> >
		HMUlChar;
