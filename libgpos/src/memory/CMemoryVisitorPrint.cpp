...
//
//---------------------------------------------------------------------------
CMemoryVisitorPrint::CMemoryVisitorPrint(IOstream &os)
	: m_ullVisits(0), m_os(os)
{
}
...
//---------------------------------------------------------------------------
void
CMemoryVisitorPrint::Visit(void *pvUserAddr, SIZE_T ulUserSize,
						   void *pvTotalAddr, SIZE_T ulTotalSize,
						   const CHAR *szAllocFilename, const ULONG ulAllocLine,
						   ULLONG ullAllocSeqNumber, CStackDescriptor *psd)
{
