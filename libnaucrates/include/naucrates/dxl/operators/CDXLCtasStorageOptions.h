...
public:
	struct CDXLCtasOption
	{
		...
		// ctor
		CDXLCtasOption(ULONG ulType, CWStringBase *pstrName,
					   CWStringBase *pstrValue, BOOL fNull)
			: m_ulType(ulType),
			  m_pstrName(pstrName),
...
private:
	...
	PstrOnCommitAction(ECtasOnCommitAction ectascommit);

public:
	// ctor
	CDXLCtasStorageOptions(CMDName *pmdnameTablespace,
