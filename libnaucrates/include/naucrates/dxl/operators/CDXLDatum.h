...
public:
	...
	// ctor
	CDXLDatum(IMemoryPool *pmp, IMDId *pmdidType, INT iTypeModifier, BOOL fNull,
			  ULONG ulLength);
	...
	virtual void
	Serialize(CXMLSerializer *pxmlser, const CWStringConst *pstrElem);
	...
	// serialize the datum as the given element
	virtual void
	Serialize(CXMLSerializer *pxmlser) = 0;
