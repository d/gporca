...
public:
	// ctor
	CDXLDatumGeneric(IMemoryPool *pmp, IMDId *pmdidType, INT iTypeModifier,
					 BOOL fByVal, BOOL fNull, BYTE *pba, ULONG ulLength);
	...
	PdxldatumConvert(CDXLDatum *pdxldatum)
	{
		...
		GPOS_ASSERT(
			CDXLDatum::EdxldatumGeneric == pdxldatum->Edxldt() ||
