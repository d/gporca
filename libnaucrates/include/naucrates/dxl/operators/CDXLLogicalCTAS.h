...
public:
	// ctor
	CDXLLogicalCTAS(IMemoryPool *pmp, IMDId *pmdid, CMDName *pmdnameSchema,
					CMDName *pmdnameRel, DrgPdxlcd *pdrgpdxcd,
					CDXLCtasStorageOptions *pdxlctasopt,
					IMDRelation::Ereldistrpolicy ereldistrpolicy,
					DrgPul *pdrgpulDistr, BOOL fTemporary, BOOL fHasOids,
