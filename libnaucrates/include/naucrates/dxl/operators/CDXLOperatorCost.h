...
public:
	// ctor/dtor
	CDXLOperatorCost(CWStringDynamic *pstrStartupCost,
					 CWStringDynamic *pstrTotalCost, CWStringDynamic *pstrRows,
	...
	void
	SetRows(CWStringDynamic *pstr);

	// set the total cost
	void
	SetCost(CWStringDynamic *pstr);
};
}  // namespace gpdxl
