...
public:
	// ctor
	CDXLScalarWindowRef(IMemoryPool *pmp, IMDId *pmdidWinfunc,
						IMDId *pmdidRetType, BOOL fDistinct, BOOL fStarArg,
						BOOL fSimpleAgg, EdxlWinStage edxlwinstage,
	...
	void
	SetWinSpecPos(ULONG ulWinspecPos)
	{
