...
private:
	...
	void
	SerializeMDId(CXMLSerializer *pxmlser) const;

public:
	// ctor/dtor
	CDXLTableDescr(IMemoryPool *pmp, IMDId *pmdid, CMDName *pmdname,
	...
	// setters
	void
	SetColumnDescriptors(DrgPdxlcd *pdrgpdxlcd);

	void
	AddColumnDescr(CDXLColDescr *pdxlcd);
	...
	void
	SerializeToDXL(CXMLSerializer *pxmlser) const;
};
}  // namespace gpdxl
