...
public:
	// ctor
	CDXLWindowSpec(IMemoryPool *pmp, DrgPul *pdrgpulPartCol, CMDName *pmdname,
				   CDXLNode *pdxlnSortColList, CDXLWindowFrame *pdxlwf);
	...
	void
	SetWindowFrame(CDXLWindowFrame *pdxlwf);
