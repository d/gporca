...
protected:
	...
	inline CParseHandlerBase *operator[](ULONG ulPos) const
	{
...
public:
	// ctor
	CParseHandlerBase(IMemoryPool *pmp, CParseHandlerManager *pphm,
	...
	void
	ReplaceParseHandler(CParseHandlerBase *pphOld, CParseHandlerBase *pphNew);
