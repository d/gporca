...
private:
	...
	void
	ParseMdid(const XMLCh *xmlszLocalname, const Attributes &attrs);

	BOOL
	FBuiltInType(const IMDId *pmdid) const;

public:
	// ctor
	CParseHandlerMDType(IMemoryPool *pmp, CParseHandlerManager *pphm,
