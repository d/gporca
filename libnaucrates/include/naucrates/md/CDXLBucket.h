...
private:
	...
	void
	SerializeBoundaryValue(CXMLSerializer *pxmlser,
						   const CWStringConst *pstrElem, CDXLDatum *pdxldatum,
						   BOOL fBoundClosed) const;

public:
	// ctor
	CDXLBucket(CDXLDatum *pdatumLower, CDXLDatum *pdatumUpper,
	...
	const CDXLDatum *
	PdxldatumLower() const;

	// max value for the bucket
	const CDXLDatum *
	PdxldatumUpper() const;
