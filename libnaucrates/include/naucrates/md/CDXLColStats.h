...
public:
	// ctor
	CDXLColStats(IMemoryPool *pmp, CMDIdColStats *pmdidColStats,
	...
	virtual const CDXLBucket *
	Pdxlbucket(ULONG ul) const;
	...
	// dummy colstats
	static CDXLColStats *
	PdxlcolstatsDummy(IMemoryPool *pmp, IMDId *pmdid, CMDName *pmdname,
					  CDouble dWidth);
};
