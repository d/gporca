...
public:
	// ctor
	CMDAggregateGPDB(IMemoryPool *pmp, IMDId *pmdid, CMDName *pmdname,
					 IMDId *pmdidTypeResult, IMDId *pmdidTypeIntermediate,
					 BOOL fOrderedAgg, BOOL fSplittable, BOOL fHashAggCapable);
