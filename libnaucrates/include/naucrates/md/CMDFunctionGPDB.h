...
public:
	// ctor/dtor
	CMDFunctionGPDB(IMemoryPool *pmp, IMDId *pmdid, CMDName *pmdname,
					IMDId *pmdidTypeResult, DrgPmdid *pdrgpmdidTypes,
					BOOL fReturnsSet, EFuncStbl efsStability,
