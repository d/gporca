...
protected:
	...
	typedef CHashMap<IMDId, CWStringDynamic, IMDId::UlHashMDId,
					 IMDId::FEqualMDId, CleanupRelease, CleanupDelete>
		MDMap;
	...
	void
	LoadMetadataObjectsFromArray(IMemoryPool *pmp, DrgPimdobj *pdrgpmdobj);
...
public:
	...
	PstrObject(IMemoryPool *pmp, CMDAccessor *pmda, IMDId *pmdid) const;

	// return the mdid for the specified system id and type
	virtual IMDId *
	Pmdid(IMemoryPool *pmp, CSystemId sysid, IMDType::ETypeInfo eti) const;
};
}  // namespace gpmd
