...
public:
	// ctor
	CMDRelationCtasGPDB(IMemoryPool *pmp, IMDId *pmdid, CMDName *pmdnameSchema,
						CMDName *pmdname, BOOL fTemporary, BOOL fHasOids,
	...
	virtual IMDId *PmdidIndex(ULONG  // ulPos
							  ) const
	{
	...
	virtual IMDId *PmdidTrigger(ULONG  // ulPos
								) const
	{
	...
	virtual IMDId *PmdidCheckConstraint(ULONG  // ulPos
										) const
	{
