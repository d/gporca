...
public:
	// ctor
	CMDRelationExternalGPDB(IMemoryPool *pmp, IMDId *pmdid, CMDName *pmdname,
							...
							INT iRejectLimit, BOOL fRejLimitInRows,
	...
	virtual BOOL
	FRejLimitInRows() const;

	// format error table mdid
	virtual IMDId *
	PmdidFmtErrRel() const;
