...
public:
	// ctor/dtor
	CMDScalarOpGPDB(IMemoryPool *pmp, IMDId *pmdid, CMDName *pmdname,
					IMDId *pmdidTypeLeft, IMDId *pmdidTypeRight,
					IMDId *pmdidTypeResult, IMDId *pmdidFunc,
					IMDId *pmdidOpCommute, IMDId *pmdidOpInverse,
					IMDType::ECmpType ecmpt, BOOL fReturnsNullOnNullInput,
	...
	virtual IMDId *
	PmdidTypeRight() const;

	// resulttype id
	virtual IMDId *
	PmdidTypeResult() const;
	...
	// commutor id
	virtual IMDId *
	PmdidOpCommute() const;

	// inverse operator id
	virtual IMDId *
	PmdidOpInverse() const;
	...
	virtual BOOL
	FReturnsNullOnNullInput() const;

	// comparison type
	virtual IMDType::ECmpType
	Ecmpt() const;
	...
	virtual IMDId *
	PmdidOpClass(ULONG ulPos) const;
