...
public:
	...
	virtual ULONG
	UlKey(ULONG ulPos) const = 0;

	// return the position of the key column
	virtual ULONG
	UlPosInKey(ULONG ulPos) const = 0;

	// number of included columns
	virtual ULONG
	UlIncludedCols() const = 0;

	// return the n-th included column
	virtual ULONG
	UlIncludedCol(ULONG ulPos) const = 0;

	// return the position of the included column
	virtual ULONG
	UlPosInIncludedCol(ULONG ulCol) const = 0;
