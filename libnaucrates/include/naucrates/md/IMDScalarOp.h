...
public:
	...
	virtual IMDId *
	PmdidTypeLeft() const = 0;

	// type of right operand
	virtual IMDId *
	PmdidTypeRight() const = 0;

	// type of result operand
	virtual IMDId *
	PmdidTypeResult() const = 0;
	...
	virtual IMDId *
	PmdidOpCommute() const = 0;

	// id of inverse operator
	virtual IMDId *
	PmdidOpInverse() const = 0;
	...
	virtual BOOL
	FReturnsNullOnNullInput() const = 0;
	...
	virtual IMDId *
	PmdidOpClass(ULONG ulPos) const = 0;
};
}  // namespace gpmd
