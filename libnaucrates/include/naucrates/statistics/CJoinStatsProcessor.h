...
protected:
	...
	static CDouble
	DJoinCardinality(CStatisticsConfig *pstatsconf, CDouble dRowsLeft,
					 CDouble dRowsRight, DrgPdouble *pdrgpd,
	...
	static BOOL
	FEmptyJoinStats(BOOL fEmptyOuter, BOOL fEmptyOutput,
					const CHistogram *phistOuter, const CHistogram *phistInner,
...
public:
	...
	static CStatistics *
	PstatsJoinDriver(IMemoryPool *pmp, CStatisticsConfig *pstatsconf,
