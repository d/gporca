...
public:
	// ctor
	explicit CStatsPred(ULONG ulColId) : m_ulColId(ulColId)
	{
	}
	...
	// comparison function
	static inline INT
	IStatsFilterCmp(const void *pv1, const void *pv2);
};  // class CStatsPred
...
INT
CStatsPred::IStatsFilterCmp(const void *pv1, const void *pv2)
{
