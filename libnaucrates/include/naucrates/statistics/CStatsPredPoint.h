...
private:
	...
	static IDatum *
	PdatumPreprocess(IMemoryPool *pmp, const CColRef *pcr, IDatum *pdatum);

public:
	// ctor
	CStatsPredPoint(ULONG ulColId, CStatsPred::EStatsCmpType escmpt,
					CPoint *ppoint);

	// ctor
	CStatsPredPoint(IMemoryPool *pmp, const CColRef *pcr,
					CStatsPred::EStatsCmpType escmpt, IDatum *pdatum);
