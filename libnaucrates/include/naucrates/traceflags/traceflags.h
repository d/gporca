...
extern "C"
{
	...
	void
	SetTraceflags(gpos::IMemoryPool *pmp, const gpos::CBitSet *pbsInput,
				  gpos::CBitSet **ppbsEnabled, gpos::CBitSet **ppbsDisabled);

	// restore trace flags values based on given bit sets
	void
	ResetTraceflags(gpos::CBitSet *pbsEnabled, gpos::CBitSet *pbsDisabled);
