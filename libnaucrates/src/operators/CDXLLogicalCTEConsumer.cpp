...
//
//---------------------------------------------------------------------------
CDXLLogicalCTEConsumer::CDXLLogicalCTEConsumer(IMemoryPool *pmp, ULONG ulId,
...
//---------------------------------------------------------------------------
BOOL
CDXLLogicalCTEConsumer::FDefinesColumn(ULONG ulColId) const
{
...
//---------------------------------------------------------------------------
void
CDXLLogicalCTEConsumer::SerializeToDXL(CXMLSerializer *pxmlser,
...
//---------------------------------------------------------------------------
void
CDXLLogicalCTEConsumer::AssertValid(const CDXLNode *pdxln,
