...
//
//---------------------------------------------------------------------------
CDXLOperator::CDXLOperator(IMemoryPool *pmp) : m_pmp(pmp)
{
}
...
//---------------------------------------------------------------------------
const CWStringConst *
CDXLOperator::PstrJoinTypeName(EdxlJoinType edxljt)
{
...
//---------------------------------------------------------------------------
const CWStringConst *
CDXLOperator::PstrIndexScanDirection(EdxlIndexScanDirection edxlisd)
{
	switch (edxlisd)
	{
