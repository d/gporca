...
//
//---------------------------------------------------------------------------
CDXLScalarMergeCondList::CDXLScalarMergeCondList(IMemoryPool *pmp)
	: CDXLScalar(pmp)
{
}
...
//---------------------------------------------------------------------------
void
CDXLScalarMergeCondList::SerializeToDXL(CXMLSerializer *pxmlser,
...
//---------------------------------------------------------------------------
void
CDXLScalarMergeCondList::AssertValid(const CDXLNode *pdxln,
