...
//
//---------------------------------------------------------------------------
CDXLWindowSpec::CDXLWindowSpec(IMemoryPool *pmp, DrgPul *pdrgpulPartCol,
							   CMDName *pmdname, CDXLNode *pdxlnSortColList,
...
//---------------------------------------------------------------------------
void
CDXLWindowSpec::SerializeToDXL(CXMLSerializer *pxmlser) const
{
	const CWStringConst *pstrElemName =
		CDXLTokens::PstrToken(EdxltokenWindowSpec);
	...
	CWStringDynamic *pstrPartCols =
		CDXLUtils::PstrSerialize(m_pmp, m_pdrgpulPartCol);
