...
//---------------------------------------------------------------------------
void
CParseHandlerBroadcastMotion::StartElement(const XMLCh *const,  // xmlszUri,
										   ...
										   const Attributes &attrs)
{
	...
	m_pdxlop = (CDXLPhysicalBroadcastMotion *)
		CDXLOperatorFactory::PdxlopBroadcastMotion(m_pphm->Pmm(), attrs);
...
//---------------------------------------------------------------------------
void
CParseHandlerBroadcastMotion::EndElement(const XMLCh *const,  // xmlszUri,
										 const XMLCh *const xmlszLocalname,
										 const XMLCh *const  // xmlszQname
)
{
	...
	CParseHandlerSortColList *pphSortCl =
