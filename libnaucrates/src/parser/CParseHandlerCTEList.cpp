...
//
//---------------------------------------------------------------------------
CParseHandlerCTEList::CParseHandlerCTEList(IMemoryPool *pmp,
										   CParseHandlerManager *pphm,
										   CParseHandlerBase *pphRoot)
	: CParseHandlerBase(pmp, pphm, pphRoot), m_pdrgpdxln(NULL)
{
}
...
//---------------------------------------------------------------------------
void
CParseHandlerCTEList::StartElement(const XMLCh *const xmlszUri,
								   ...
								   const Attributes &attrs)
{
					  ...
					  xmlszLocalname))
	{
		...
		CParseHandlerBase *pphCTEProducer = CParseHandlerFactory::Pph(
			m_pmp, CDXLTokens::XmlstrToken(EdxltokenLogicalCTEProducer), m_pphm,
			this);
		...
		pphCTEProducer->startElement(xmlszUri, xmlszLocalname, xmlszQname,
									 attrs);
	}
	else
	{
...
//---------------------------------------------------------------------------
void
CParseHandlerCTEList::EndElement(const XMLCh *const,  // xmlszUri,
								 const XMLCh *const xmlszLocalname,
								 const XMLCh *const  // xmlszQname
)
{
	...
	{
		CParseHandlerLogicalCTEProducer *pphCTE =
