...
void
CParseHandlerFactory::AddMapping(Edxltoken edxltok,
...
void
CParseHandlerFactory::Init(IMemoryPool *pmp)
{
...
CParseHandlerBase *
CParseHandlerFactory::Pph(IMemoryPool *pmp, const XMLCh *xmlszName,
						  ...
						  CParseHandlerBase *pphRoot)
{
	...
	GPOS_RAISE(gpdxl::ExmaDXL, gpdxl::ExmiDXLUnrecognizedOperator, pstr->Wsz());
...
CParseHandlerDXL *
CParseHandlerFactory::Pphdxl(IMemoryPool *pmp, CParseHandlerManager *pphm)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPlan(IMemoryPool *pmp, CParseHandlerManager *pphm,
							  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMetadata(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDRequest(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphTraceFlags(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphOptimizerConfig(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphEnumeratorConfig(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphStatisticsConfig(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphCTEConfig(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphCostModelConfig(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphHint(IMemoryPool *pmp, CParseHandlerManager *pphm,
							  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindowOids(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMetadataRelation(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMetadataRelationExternal(IMemoryPool *pmp,
												  CParseHandlerManager *pphm,
												  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMetadataRelationCTAS(IMemoryPool *pmp,
											  CParseHandlerManager *pphm,
											  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDIndex(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphRelStats(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphColStats(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphColStatsBucket(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDGPDBType(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDGPDBScalarOp(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDGPDBFunc(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDGPDBAgg(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDGPDBTrigger(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDCast(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDScCmp(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMetadataIdList(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMetadataColumns(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDIndexInfoList(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMetadataColumn(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphColumnDefaultValueExpr(IMemoryPool *pmp,
												CParseHandlerManager *pphm,
												CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhysOp(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarOp(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphProperties(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphFilter(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphTableScan(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphBitmapTableScan(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerPhysicalBitmapTableScan(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing a dynamic bitmap table scan
CParseHandlerBase *
CParseHandlerFactory::PphDynamicBitmapTableScan(IMemoryPool *pmp,
												CParseHandlerManager *pphm,
												CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerPhysicalDynamicBitmapTableScan(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing an external scan
CParseHandlerBase *
CParseHandlerFactory::PphExternalScan(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphSubqScan(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphResult(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphHashJoin(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphNLJoin(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMergeJoin(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphSort(IMemoryPool *pmp, CParseHandlerManager *pphm,
							  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphAppend(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMaterialize(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphDynamicTableScan(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphDynamicIndexScan(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPartitionSelector(IMemoryPool *pmp,
										   CParseHandlerManager *pphm,
										   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphSequence(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLimit(IMemoryPool *pmp, CParseHandlerManager *pphm,
							   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLimitcount(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarSubquery(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarBitmapBoolOp(IMemoryPool *pmp,
											CParseHandlerManager *pphm,
											CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarArray(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarArrayRef(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarArrayRefIndexList(IMemoryPool *pmp,
												 CParseHandlerManager *pphm,
												 CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerScalarArrayRefIndexList(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing a scalar assert predicate operator.
CParseHandlerBase *
CParseHandlerFactory::PphScalarAssertConstraintList(IMemoryPool *pmp,
													CParseHandlerManager *pphm,
													CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerScalarAssertConstraintList(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing a scalar DML action operator.
CParseHandlerBase *
CParseHandlerFactory::PphScalarDMLAction(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarOpList(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarPartOid(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarPartDefault(IMemoryPool *pmp,
										   CParseHandlerManager *pphm,
										   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarPartBound(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarPartBoundInclusion(IMemoryPool *pmp,
												  CParseHandlerManager *pphm,
												  CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerScalarPartBoundInclusion(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing a scalar part bound openness
CParseHandlerBase *
CParseHandlerFactory::PphScalarPartBoundOpen(IMemoryPool *pmp,
											 CParseHandlerManager *pphm,
											 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarPartListValues(IMemoryPool *pmp,
											  CParseHandlerManager *pphm,
											  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarPartListNullTest(IMemoryPool *pmp,
												CParseHandlerManager *pphm,
												CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerScalarPartListNullTest(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing direct dispatch info
CParseHandlerBase *
CParseHandlerFactory::PphDirectDispatchInfo(IMemoryPool *pmp,
											CParseHandlerManager *pphm,
											CParseHandlerBase *pphRoot)
{
...
// creates a parse handler for parsing a Limit Count operator
CParseHandlerBase *
CParseHandlerFactory::PphLimitoffset(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphGatherMotion(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphBroadcastMotion(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphRedistributeMotion(IMemoryPool *pmp,
											CParseHandlerManager *pphm,
											CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphRoutedMotion(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphRandomMotion(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphAgg(IMemoryPool *pmp, CParseHandlerManager *pphm,
							 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphAggref(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
// operator
CParseHandlerBase *
CParseHandlerFactory::PphGroupingColList(IMemoryPool *pmp,
										 CParseHandlerManager *pphm,
										 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarCmp(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphDistinctCmp(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarId(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarFuncExpr(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarOpexpr(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
// creates a parse handler for parsing a scalar OpExpr
CParseHandlerBase *
CParseHandlerFactory::PphScalarArrayCmp(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarBoolExpr(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarMinMax(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphBooleanTest(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarNullTest(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarNullIf(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarCast(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarCoerceToDomain(IMemoryPool *pmp,
											  CParseHandlerManager *pphm,
											  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarCoerceViaIO(IMemoryPool *pmp,
										   CParseHandlerManager *pphm,
										   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarArrayCoerceExpr(IMemoryPool *pmp,
											   CParseHandlerManager *pphm,
											   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarSubPlan(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarSubPlanTestExpr(IMemoryPool *pmp,
											   CParseHandlerManager *pphm,
											   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarSubPlanParamList(IMemoryPool *pmp,
												CParseHandlerManager *pphm,
												CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerScalarSubPlanParamList(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing a single SubPlan Param
CParseHandlerBase *
CParseHandlerFactory::PphScalarSubPlanParam(IMemoryPool *pmp,
											CParseHandlerManager *pphm,
											CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLogicalTVF(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhysicalTVF(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarCoalesce(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarSwitch(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarSwitchCase(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarCaseTest(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarConstValue(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphIfStmt(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphProjList(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphProjElem(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphHashExprList(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
// motion node
CParseHandlerBase *
CParseHandlerFactory::PphHashExpr(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
// merge join node
CParseHandlerBase *
CParseHandlerFactory::PphCondList(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphSortColList(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphSortCol(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
// operator
CParseHandlerBase *
CParseHandlerFactory::PphCost(IMemoryPool *pmp, CParseHandlerManager *pphm,
							  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphTableDesc(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphColDesc(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphIndexScan(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphIndexOnlyScan(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphBitmapIndexProbe(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerScalarBitmapIndexProbe(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing an index descriptor of an
// index scan node
CParseHandlerBase *
CParseHandlerFactory::PphIndexDescr(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
// index scan node
CParseHandlerBase *
CParseHandlerFactory::PphIndexCondList(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphQuery(IMemoryPool *pmp, CParseHandlerManager *pphm,
							   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgOp(IMemoryPool *pmp, CParseHandlerManager *pphm,
							  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgGet(IMemoryPool *pmp, CParseHandlerManager *pphm,
							   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgExternalGet(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgProject(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgCTEProducer(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgCTEConsumer(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgCTEAnchor(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphCTEList(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgSetOp(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgSelect(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgJoin(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphQueryOutput(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgGrpBy(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgLimit(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgConstTable(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScSubqueryQuantified(IMemoryPool *pmp,
											  CParseHandlerManager *pphm,
											  CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp)
		CParseHandlerScalarSubqueryQuantified(pmp, pphm, pphRoot);
}

// creates a parse handler for parsing an EXISTS/NOT EXISTS subquery operator
CParseHandlerBase *
CParseHandlerFactory::PphScSubqueryExists(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphStats(IMemoryPool *pmp, CParseHandlerManager *pphm,
							   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphStacktrace(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
// creates a parse handler for parsing relation statistics
CParseHandlerBase *
CParseHandlerFactory::PphStatsDerivedRelation(IMemoryPool *pmp,
											  CParseHandlerManager *pphm,
											  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphStatsDerivedColumn(IMemoryPool *pmp,
											CParseHandlerManager *pphm,
											CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphStatsBucketBound(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindow(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindowRef(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindowFrame(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindowKey(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindowKeyList(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindowSpec(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindowSpecList(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgWindow(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgInsert(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgDelete(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgUpdate(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphLgCTAS(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhCTAS(IMemoryPool *pmp, CParseHandlerManager *pphm,
								CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphCTASOptions(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhCTEProducer(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhCTEConsumer(IMemoryPool *pmp,
									   CParseHandlerManager *pphm,
									   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhDML(IMemoryPool *pmp, CParseHandlerManager *pphm,
							   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhSplit(IMemoryPool *pmp, CParseHandlerManager *pphm,
								 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhRowTrigger(IMemoryPool *pmp,
									  CParseHandlerManager *pphm,
									  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphPhAssert(IMemoryPool *pmp, CParseHandlerManager *pphm,
								  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphWindowFrameTrailingEdge(IMemoryPool *pmp,
												 CParseHandlerManager *pphm,
												 CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp) CParseHandlerScalarWindowFrameEdge(pmp, pphm, pphRoot,
															false /*fLeading*/);
}

// creates a leading window frame edge parser
CParseHandlerBase *
CParseHandlerFactory::PphWindowFrameLeadingEdge(IMemoryPool *pmp,
												CParseHandlerManager *pphm,
												CParseHandlerBase *pphRoot)
{
	return GPOS_NEW(pmp) CParseHandlerScalarWindowFrameEdge(pmp, pphm, pphRoot,
...
CParseHandlerBase *
CParseHandlerFactory::PphSearchStrategy(IMemoryPool *pmp,
										CParseHandlerManager *pphm,
										CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphSearchStage(IMemoryPool *pmp,
									 CParseHandlerManager *pphm,
									 CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphXform(IMemoryPool *pmp, CParseHandlerManager *pphm,
							   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphCostParams(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphCostParam(IMemoryPool *pmp, CParseHandlerManager *pphm,
								   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarExpr(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDGPDBCheckConstraint(IMemoryPool *pmp,
											   CParseHandlerManager *pphm,
											   CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphScalarValuesList(IMemoryPool *pmp,
										  CParseHandlerManager *pphm,
										  CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphValuesScan(IMemoryPool *pmp,
									CParseHandlerManager *pphm,
									CParseHandlerBase *pphRoot)
{
...
CParseHandlerBase *
CParseHandlerFactory::PphMDArrayCoerceCast(IMemoryPool *pmp,
										   CParseHandlerManager *pphm,
										   CParseHandlerBase *pphRoot)
{
