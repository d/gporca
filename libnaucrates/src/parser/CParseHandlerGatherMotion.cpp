...
//
//---------------------------------------------------------------------------
CParseHandlerGatherMotion::CParseHandlerGatherMotion(IMemoryPool *pmp,
...
//---------------------------------------------------------------------------
void
CParseHandlerGatherMotion::StartElement(const XMLCh *const,  // xmlszUri,
										...
										const Attributes &attrs)
{
	...
	m_pdxlop =
		(CDXLPhysicalGatherMotion *) CDXLOperatorFactory::PdxlopGatherMotion(
			m_pphm->Pmm(), attrs);
...
//---------------------------------------------------------------------------
void
CParseHandlerGatherMotion::EndElement(const XMLCh *const,  // xmlszUri,
									  const XMLCh *const xmlszLocalname,
									  const XMLCh *const  // xmlszQname
)
{
