...
//
//---------------------------------------------------------------------------
CParseHandlerMergeJoin::CParseHandlerMergeJoin(IMemoryPool *pmp,
...
//---------------------------------------------------------------------------
void
CParseHandlerMergeJoin::StartElement(const XMLCh *const,  // xmlszUri,
									 ...
									 const Attributes &attrs)
{
	...
	m_pdxlop = (CDXLPhysicalMergeJoin *) CDXLOperatorFactory::PdxlopMergeJoin(
		m_pphm->Pmm(), attrs);
	...
	CParseHandlerBase *pphMergeCl = CParseHandlerFactory::Pph(
		m_pmp, CDXLTokens::XmlstrToken(EdxltokenScalarMergeCondList), m_pphm,
		this);
...
//---------------------------------------------------------------------------
void
CParseHandlerMergeJoin::EndElement(const XMLCh *const,  // xmlszUri,
								   const XMLCh *const xmlszLocalname,
								   const XMLCh *const  // xmlszQname
)
{
	...
	CParseHandlerCondList *pphMergeCl =
