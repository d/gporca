...
//
//---------------------------------------------------------------------------
CParseHandlerPhysicalCTAS::CParseHandlerPhysicalCTAS(IMemoryPool *pmp,
...
//---------------------------------------------------------------------------
void
CParseHandlerPhysicalCTAS::StartElement(const XMLCh *const,  // xmlszUri,
										...
										const Attributes &attrs)
{
	...
	m_fTemporary = CDXLOperatorFactory::FValueFromAttrs(
		m_pphm->Pmm(), attrs, EdxltokenRelTemporary, EdxltokenPhysicalCTAS);
	m_fHasOids = CDXLOperatorFactory::FValueFromAttrs(
		m_pphm->Pmm(), attrs, EdxltokenRelHasOids, EdxltokenPhysicalCTAS);
...
//---------------------------------------------------------------------------
void
CParseHandlerPhysicalCTAS::EndElement(const XMLCh *const,  // xmlszUri,
									  const XMLCh *const xmlszLocalname,
									  const XMLCh *const  // xmlszQname
)
{
	...
	m_pdxln = GPOS_NEW(m_pmp) CDXLNode(
		m_pmp, GPOS_NEW(m_pmp) CDXLPhysicalCTAS(
				   m_pmp, m_pmdnameSchema, m_pmdname, pdrgpdxlcd, pdxlctasopt,
