...
//
//---------------------------------------------------------------------------
CParseHandlerRandomMotion::CParseHandlerRandomMotion(IMemoryPool *pmp,
...
//---------------------------------------------------------------------------
void
CParseHandlerRandomMotion::StartElement(const XMLCh *const,  // xmlszUri,
										...
										const Attributes &attrs)
{
	...
	m_pdxlop =
		(CDXLPhysicalRandomMotion *) CDXLOperatorFactory::PdxlopRandomMotion(
			m_pphm->Pmm(), attrs);
...
//---------------------------------------------------------------------------
void
CParseHandlerRandomMotion::EndElement(const XMLCh *const,  // xmlszUri,
									  const XMLCh *const xmlszLocalname,
									  const XMLCh *const  // xmlszQname
)
{
