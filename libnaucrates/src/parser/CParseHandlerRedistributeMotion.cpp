...
//---------------------------------------------------------------------------
void
CParseHandlerRedistributeMotion::StartElement(const XMLCh *const,  // xmlszUri,
											  ...
											  const Attributes &attrs)
{
	...
	m_pdxlop = (CDXLPhysicalRedistributeMotion *)
		CDXLOperatorFactory::PdxlopRedistributeMotion(m_pphm->Pmm(), attrs);
	...
	CParseHandlerBase *pphHExprList = CParseHandlerFactory::Pph(
		m_pmp, CDXLTokens::XmlstrToken(EdxltokenScalarHashExprList), m_pphm,
		this);
...
//---------------------------------------------------------------------------
void
CParseHandlerRedistributeMotion::EndElement(const XMLCh *const,  // xmlszUri,
											const XMLCh *const xmlszLocalname,
											const XMLCh *const  // xmlszQname
)
{
	...
	CParseHandlerHashExprList *pphHExprList =
