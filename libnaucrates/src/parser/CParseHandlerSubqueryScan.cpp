...
//
//---------------------------------------------------------------------------
CParseHandlerSubqueryScan::CParseHandlerSubqueryScan(IMemoryPool *pmp,
...
//---------------------------------------------------------------------------
void
CParseHandlerSubqueryScan::StartElement(const XMLCh *const,  // xmlszUri,
										...
										const Attributes &attrs)
{
	...
	m_pdxlop = (CDXLPhysicalSubqueryScan *) CDXLOperatorFactory::PdxlopSubqScan(
		m_pphm->Pmm(), attrs);
...
//---------------------------------------------------------------------------
void
CParseHandlerSubqueryScan::EndElement(const XMLCh *const,  // xmlszUri,
									  const XMLCh *const xmlszLocalname,
									  const XMLCh *const  // xmlszQname
)
{
