...
private:
	...
	static GPOS_RESULT
	EresParseAndSerializePlan(IMemoryPool *, const CHAR *, BOOL fValidate);

	// test parsing and serializing of queries
	static GPOS_RESULT
	EresParseAndSerializeQuery(IMemoryPool *, const CHAR *, BOOL fValidate);

	// test parsing and serializing of metadata
	static GPOS_RESULT
	EresParseAndSerializeMetadata(IMemoryPool *, const CHAR *, BOOL fValidate);

	// test parsing and serializing of metadata requests
	static GPOS_RESULT
	EresParseAndSerializeMDRequest(IMemoryPool *, const CHAR *, BOOL fValidate);

	// test parsing and serializing of stats
	static GPOS_RESULT
	EresParseAndSerializeStatistics(IMemoryPool *, const CHAR *,
									BOOL fValidate);

	// test parsing and serializing of scalar expressions
	static GPOS_RESULT
	EresParseAndSerializeScalarExpr(IMemoryPool *, const CHAR *,
									BOOL fValidate);
...
public:
	...
	// run all plan tests
	static GPOS_RESULT
	EresUnittest_RunPlanTests();

	// run all positive tests
	static GPOS_RESULT
	EresUnittest_RunAllPositiveTests(const CHAR *rgszFileNames[], ULONG ulFiles,
