...
private:
	...
	static BOOL
	FMatchBucketBoundary(CBucket *pbucket1, CBucket *pbucket2);
...
public:
	...
	// bucket basic tests
	static GPOS_RESULT
	EresUnittest_CBucketInt4();

	static GPOS_RESULT
	EresUnittest_CBucketBool();

	// bucket intersect
	static GPOS_RESULT
	EresUnittest_CBucketIntersect();

	// bucket scaling tests
	static GPOS_RESULT
	EresUnittest_CBucketScale();
