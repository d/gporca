...
public:
	...
	static void
	GenerateGetExpressions(IMemoryPool *pmp, CExpression **ppexprOuter,
						   CExpression **ppexprInner);

	// generate a random join expression with a subquery predicate
	static CExpression *
	PexprJoinWithAggSubquery(IMemoryPool *pmp, BOOL fCorrelated);

	// generate a select  expression with subquery equality predicate
	static CExpression *
	PexprSelectWithAggSubquery(IMemoryPool *pmp, CExpression *pexprOuter,
	...
	static CExpression *
	PexprSelectWithAggSubqueryConstComparison(IMemoryPool *pmp,
	...
	static CExpression *
	PexprProjectWithAggSubquery(IMemoryPool *pmp, CExpression *pexprOuter,
								CExpression *pexprInner, BOOL fCorrelated);

	// generate a random select expression with a subquery predicate
	static CExpression *
	PexprSelectWithAggSubquery(IMemoryPool *pmp, BOOL fCorrelated);
