...
private:
	...
	public:
		// ctor
		CDummyConstDXLNodeEvaluator(IMemoryPool *pmp, CMDAccessor *pmda,
									INT iVal)
			: m_pmp(pmp), m_pmda(pmda), m_iVal(iVal)
		{
		}
		...
		virtual gpdxl::CDXLNode *
		PdxlnEvaluateExpr(const gpdxl::CDXLNode *pdxlnExpr);
