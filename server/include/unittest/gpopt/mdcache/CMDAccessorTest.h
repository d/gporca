...
public:
	...
	EresUnittest_Datum();
	static GPOS_RESULT
	EresUnittest_DatumGeneric();
	static GPOS_RESULT
	EresUnittest_Navigate();
	static GPOS_RESULT
	EresUnittest_Negative();
	static GPOS_RESULT
	EresUnittest_Indexes();
	static GPOS_RESULT
	EresUnittest_CheckConstraint();
	static GPOS_RESULT
	EresUnittest_IndexPartConstraint();
	static GPOS_RESULT
	EresUnittest_Cast();
	static GPOS_RESULT
	EresUnittest_ScCmp();
	...
	static GPOS_RESULT
	EresUnittest_ConcurrentAccessSingleMDA();
	static GPOS_RESULT
	EresUnittest_ConcurrentAccessMultipleMDA();
	static GPOS_RESULT
	EresUnittest_PrematureMDIdRelease();
