...
private:
	...
	static DrgPss *
	PdrgpssRandom(IMemoryPool *pmp);

	// run optimize function on given expression
	static void
	Optimize(IMemoryPool *pmp, Pfpexpr pfnGenerator, DrgPss *pdrgpss,
