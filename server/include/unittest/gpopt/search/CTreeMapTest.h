...
class CTreeMapTest
{
	...
	public:
		...
		// debug print
		IOstream &
		OsPrint(IOstream &os, ULONG ulIndent = 0) const;
	};
...
private:
	...
	static CNode *
	Pnd(IMemoryPool *pmp, ULONG *pul, DrgPnd *pdrgpnd, BOOL *fTestTrue);
...
public:
	...
	static GPOS_RESULT
	EresUnittest_FailedPlanEnumerationTests();
#endif  // GPOS_DEBUG
