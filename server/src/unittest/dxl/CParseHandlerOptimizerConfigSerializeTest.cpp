...
public:
	...
	const CHAR *
	SzDxl(const CHAR *szDXLFileName)
	{
...
static void
SerializeOptimizerConfig(IMemoryPool *pmp, COptimizerConfig *poconf,
						 COstream &oos, BOOL fIndent)
{
...
CParseHandlerOptimizerConfigSerializeTest::EresUnittest()
{
	...
	COptimizerConfig *poc =
		CDXLUtils::PoptimizerConfigParseDXL(pmp, szDXL, szValidationPath);
