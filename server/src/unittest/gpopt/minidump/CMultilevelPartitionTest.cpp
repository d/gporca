...
const CHAR *rgszMultilevel[] = {
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-Casting-cast_boundary_value_to_date.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-Casting-cast_partition_column_to_text.mdp",
	"../data/dxl/multilevel-partitioning/Multilevel-Casting-no_casting.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-Casting-predicate-on-all-levels.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-Casting-predicate-on-non-leaf-levels.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-Casting-predicate-on-non-root-levels.mdp",
	"../data/dxl/multilevel-partitioning/Multilevel-FullScan.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-ConstPred-Level1-NoDefault.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-ConstPred-Level1-Default.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-ConstPred-Level2-NoDefault.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-ConstPred-Level2-Default.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-ConstPred-AllLevels-NoDefault.mdp",
	"../data/dxl/multilevel-partitioning/"
	"Multilevel-ConstPred-AllLevels-Default.mdp",
...
CMultilevelPartitionTest::EresUnittest_RunTests()
{
	...
	return CTestUtils::EresRunMinidumps(pmp, rgszMultilevel, ulTests,
										&m_ulMLPTTestCounter,
										1,	 // ulSessionId
										1,	 // ulCmdId
										true,  // fMatchPlans
